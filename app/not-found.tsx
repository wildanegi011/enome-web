            ...
            >
                ...
                >
                    <div className="space-y-3">
                        <h2 className="font-heading text-4xl font-semibold text-neutral-base-800 dark:text-neutral-base-200 sm:text-5xl">
                            Halaman Tidak Ditemukan
                        </h2>
                        <p className="mx-auto max-w-lg text-lg text-neutral-base-600 dark:text-neutral-base-400">
                            Maaf, sepertinya Anda tersesat di antara koleksi eksklusif kami.
                            Halaman yang Anda cari telah berpindah atau tidak tersedia saat ini.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row">
                        <Button
                            ...
                            variant="default"
                            size="lg"
                            className="group relative h-14 gap-3 overflow-hidden rounded-full bg-neutral-base-900 px-10 text-lg text-white transition-all hover:scale-105 hover:bg-neutral-base-800 active:scale-95 dark:bg-neutral-base-100 dark:text-neutral-base-950 dark:hover:bg-white"
                        >
                            <Link href="/">
                        ...
                        <Button
                            ...
                            variant="ghost"
                            size="lg"
                            className="group h-14 gap-3 rounded-full text-neutral-base-600 hover:bg-neutral-base-200/50 dark:text-neutral-base-400 dark:hover:bg-white/5"
                        >

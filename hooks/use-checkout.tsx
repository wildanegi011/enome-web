...
export function useCheckout() {
            ...
            if (currentAddr) {
                ...
                if (hasChanged) {
                    setShippingForm(prev => ({
                        ...
                        kelurahan: currentAddr.kelurahan || "",
                        kelurahanName: currentAddr.kelurahanName || currentAddr.kelurahan || "",
        ...
        if (addresses.length > 0 && shippingForm.addressId === 0) {
            ...
            if (defaultAddr) {
                setShippingForm(prev => ({
                    ...
                    kelurahanName: defaultAddr.kelurahanName || defaultAddr.kelurahan || "",
    ...
    const handleSelectAddress = (addr: Address) => {
        setShippingForm({
            ...
            kelurahanName: addr.kelurahanName || addr.kelurahan || "",

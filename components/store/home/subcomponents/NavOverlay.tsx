        ...
        <div className="absolute top-0 left-0 right-0 z-50 pointer-events-none">
            <div className="flex items-center justify-between md:justify-start md:gap-2.5 px-6 py-6 md:px-12 md:py-10">
                ...
                >
                    ...
                    {/* Cart Button - Only visible if logged in */}
                    {isAuthenticated && (
                        <button
                        ...
                        >
                            ...
                            {count > 0 && (
                                <span className="absolute -top-1 -right-1 size-5 bg-red-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center border-2 border-black/10">
                                    {count}
                                </span>
                            )}
                        </button>

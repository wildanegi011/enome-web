                                ...
                                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                                    {item.ukuran && (
                                        <p className="flex items-center gap-1.5">
                                            <span className="text-[13px] font-bold text-neutral-base-400  tracking-wider font-montserrat">Ukuran</span>
                                            <span className="text-[13px] font-bold text-neutral-base-900">{item.ukuran}</span>
                                        </p>
                                    )}
                                    {item.variant && (
                                        <p className="flex items-center gap-1.5">
                                            <span className="text-[13px] font-bold text-neutral-base-400  tracking-wider font-montserrat">Varian</span>
                                            <span className="text-[13px] font-bold text-neutral-base-900">{item.variant}</span>
                                        </p>
                                    )}
                                    {item.warna && (
                                        <p className="flex items-center gap-1.5">
                                            <span className="text-[13px] font-bold text-neutral-base-400  tracking-wider font-montserrat">Warna</span>
                                            <span className="text-[13px] font-bold text-neutral-base-900">{item.warna}</span>
                                        </p>
                                    )}
                                    <p className="flex items-center gap-1.5">
                                        <span className="text-[13px] font-bold text-neutral-base-400  tracking-wider font-montserrat">Qty</span>
                                        <span className="text-[13px] font-bold text-neutral-base-900">{item.qty}</span>
                                    </p>
                                </div>
                                {item.catatan && (

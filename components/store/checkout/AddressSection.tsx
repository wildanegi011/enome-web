        ...
        <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between border-b border-neutral-base-50 pb-6">
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-2xl bg-amber-50 flex items-center justify-center font-black text-amber-800 text-[18px]">2</div>
                ...
                {addresses.length > 0 ? (
                    ...
                    <button
                        onClick={() => setIsAddAddressModalOpen(true)}
                        className="text-[10px] font-black text-white uppercase tracking-widest flex items-center gap-1.5 hover:bg-neutral-base-800 transition-all bg-neutral-base-900 px-4 py-2 rounded-full shadow-lg shadow-neutral-base-900/10"
                    >
                        <Plus className="w-3 h-3" />
                        Tambah Alamat
                    </button>
            ...
            <div className="flex flex-col gap-8">
                {shippingForm.addressId > 0 && addresses.find(a => a.id === shippingForm.addressId) ? (
                    <div className="bg-neutral-base-50/30 p-1 rounded-[32px] border border-neutral-base-100/60 overflow-hidden">
                        <AddressCard
                    ...
                    <div className="bg-neutral-base-50/30 rounded-[32px] p-8 border border-neutral-base-100/60 flex flex-col gap-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="flex flex-col gap-3 md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    className="min-h-[120px] bg-white border border-neutral-base-100 rounded-2xl p-6 outline-none focus:border-amber-800 focus:ring-4 focus:ring-amber-50/50 font-bold text-[14px] transition-all shadow-sm resize-none placeholder:text-neutral-base-200"

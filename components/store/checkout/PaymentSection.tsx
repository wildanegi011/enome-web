                                            ...
                                            >
                                                <div className="flex items-center gap-3 md:gap-4">
                                                    ...
                                                    <div className="flex flex-col items-start text-left">
                                                        ...
                                                        {isDisabled ? (
                                                            <p className="text-[10px] md:text-[11px] font-black text-red-500 uppercase tracking-widest mt-0.5 md:mt-1">Min. Transfer Rp 10.000</p>
                                                        ) : (
                                                            <p className="text-[10px] md:text-[11px] font-black text-neutral-base-400 uppercase tracking-widest mt-0.5 md:mt-1">{method.namaPemilik}</p>
                                                        )}
                                                    </div>
                                                </div>

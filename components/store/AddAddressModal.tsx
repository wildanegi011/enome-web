...
import {
    MapPin, Search, Loader2, Home,
    User, Phone, Store, Navigation2,
    Check, AlertCircle
} from "lucide-react";
...
export default function AddAddressModal({ open, onOpenChange, initialData }: AddAddressModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[80vh] p-0 sm:p-0 bg-white rounded-[32px] md:rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] border-none overflow-hidden flex flex-col">
                <DialogHeader className="p-10 md:p-10 -mb-12 flex flex-row items-center justify-between shrink-0">
                    <div className="flex items-center gap-4 md:gap-5">
                        ...
                        <div>
                            ...
                            <DialogDescription className="text-[12px] md:text-[13px] font-bold text-neutral-base-400 mt-0.5 md:mt-1">
                                {mode === "edit" ? "Perbarui informasi pengiriman kamu" : "Kirim pesanan kamu ke lokasi yang tepat"}
                            </DialogDescription>
                        </div>
                    </div>
                </DialogHeader>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar px-6 md:px-10 pb-6 md:pb-10">
                    <form onSubmit={handleSubmit} className="pt-6 md:pt-8 space-y-8 md:space-y-10">
                        {/* Section: Contact Info */}
                        <div className="space-y-4 md:space-y-6">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-8 h-8 rounded-xl bg-neutral-base-50 flex items-center justify-center">
                                    <User className="w-4 h-4 text-neutral-base-400" />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group/input">
                                        <Input
                                            ...
                                            className="h-14 bg-neutral-base-50/30 border-neutral-base-100/60 rounded-[20px] px-6 font-bold text-[14px] focus:bg-white focus:border-amber-800 focus:ring-4 focus:ring-amber-50/50 transition-all placeholder:text-neutral-base-300 group-hover/input:border-neutral-base-200"
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="space-y-6 pt-4 border-t border-neutral-base-100/60 relative">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-8 h-8 rounded-xl bg-neutral-base-50 flex items-center justify-center">
                                    <Navigation2 className="w-4 h-4 text-neutral-base-400" />
                                </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-6">
                            <Button
                                ...
                                className="h-16 px-8 rounded-full font-black text-[12px] uppercase tracking-[0.2em] text-neutral-base-400 hover:text-neutral-base-900 hover:bg-neutral-base-50 transition-all order-2 sm:order-1"
                            >
                                Batal
                            </Button>
                            <Button
                                ...
                                className="h-16 px-10 rounded-full bg-neutral-base-900 text-white font-black text-[12px] uppercase tracking-[0.2em] hover:bg-amber-800 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-neutral-base-900/10 flex-1 order-1 sm:order-2 disabled:opacity-50"
                            >
                                {mutation.isPending ? (
